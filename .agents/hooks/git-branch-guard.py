...
BRANCH_NAME_RE = re.compile(r"^(UC|NP|CURA|PP)-\d+[-_][a-z0-9]+([-_][a-z0-9]+)*$", re.I)
...
def check_branch():
    ...
    if branch and not BRANCH_NAME_RE.match(branch):
        print(
            ...
            f"`<PROJECT_KEY>-<number>[-_]description` (e.g. UC-3697_AI_DF or NP-1325-fix-eval).\n"
