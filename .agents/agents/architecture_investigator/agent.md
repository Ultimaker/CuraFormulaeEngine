...
Description: Applies the `software-architect` skill to `CuraFormulaeEngine` and writes the architecture section of AGENTS.md.
...
You are a software architect investigating `CuraFormulaeEngine` in order to write
