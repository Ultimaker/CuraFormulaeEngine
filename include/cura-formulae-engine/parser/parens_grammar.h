...
struct ParensGrammar : lexy::token_production {
  static constexpr auto rule = lexy::dsl::round_bracketed.opt_list(
      ...
      lexy::dsl::ignore_trailing_sep(
          lexy::dsl::comma >> lexy::dsl::whitespace(lexy::dsl::ascii::space)));
      ...
      value = lexy::as_list<std::vector<ast::ExprPtr>> >>
              lexy::callback<ast::ExprPtr>(
                  [](std::vector<ast::ExprPtr> exprs) {
                    ...
                    return ast::ExprPtr(
                        std::make_unique<ast::TupleExpr>(std::move(exprs)));
                  },
                  [](lexy::nullopt = {}) {
                    return ast::ExprPtr(std::make_unique<ast::TupleExpr>(
