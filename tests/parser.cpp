...
TEST_CASE("expression or operator", "[parser, expression]") {
  ...
  const auto expected_ast =
      make_expr_ptr<BoolExpr>(true) || make_expr_ptr<BoolExpr>(false);
  const auto expected_eval = CuraFormulaeEngine::eval::Value(true);
...
TEST_CASE("expression addition operator with float and bool",
          "[parser, expression]") {
  auto input = "True + 0.4"sv;
  const auto expected_ast =
      make_expr_ptr<BoolExpr>(true) + make_expr_ptr<FloatExpr>(0.4);
...
TEST_CASE("expression pow operator", "[parser, expression]") {
  auto input = "2 ** 3"sv;
  const auto expected_ast = make_expr_ptr<PowExpr>(make_expr_ptr<IntExpr>(2),
...
TEST_CASE("expression decimal pow operator", "[parser, expression]") {
  auto input = "9 ** 0.5"sv;
  const auto expected_ast = make_expr_ptr<PowExpr>(
      make_expr_ptr<IntExpr>(9), make_expr_ptr<FloatExpr>(0.5));
...
TEST_CASE("expression multiply operator", "[parser, expression]") {
  auto input = "2 * 2"sv;
  const auto expected_ast =
      make_expr_ptr<IntExpr>(2) * make_expr_ptr<IntExpr>(2);
...
TEST_CASE("expression multiple operators", "[parser, expression]") {
  ...
  const auto expected_ast = make_expr_ptr<IntExpr>(4) +
                            make_expr_ptr<PowExpr>(make_expr_ptr<IntExpr>(4),
...
TEST_CASE("2 < 3", "[parser, expression]") {
  ...
  auto expected_ast =
      make_expr_ptr<IntExpr>(int64_t(2)) < make_expr_ptr<IntExpr>(int64_t(3));
...
TEST_CASE("15 < 300 < 25", "[parser, expression]") {
  ...
  auto expected_ast = make_expr_ptr<ComparisonChainExpr>(
      std::move(numbers), std::vector{ComparisonOperators::LessThan,
...
TEST_CASE("1 < 2 <= 2", "[parser, expression]") {
  ...
  auto expected_ast = make_expr_ptr<ComparisonChainExpr>(
      std::move(numbers), std::vector{ComparisonOperators::LessThan,
                                      ComparisonOperators::LessThenEqual});
  const auto expected_eval = CuraFormulaeEngine::eval::Value(true);
...
TEST_CASE("simple variable", "[parser, variable]") {
  ...
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::string("bar"));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
...
TEST_CASE("empty tuple", "[parser, tuple]") {
  ...
  const auto expected_eval = CuraFormulaeEngine::eval::Value(
      std::vector<CuraFormulaeEngine::eval::Value>{});
...
TEST_CASE("double tuple", "[parser, tuple]") {
  auto input = "(1, 2)"sv;
  const auto expected_ast = make_tuple_expr(make_expr_ptr<IntExpr>(int64_t(1)),
                                            make_expr_ptr<IntExpr>(int64_t(2)));
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{int64_t(1), int64_t(2)}};
...
TEST_CASE("fn cos", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("math.cos")(
      make_expr_ptr<VariableExpr>("math.pi"));
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::cos(std::numbers::pi));
...
TEST_CASE("fn sin", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("math.sin")(
      make_expr_ptr<VariableExpr>("math.pi"));
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::sin(std::numbers::pi));
...
TEST_CASE("fn tan", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("math.tan")(
      make_expr_ptr<VariableExpr>("math.pi"));
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::tan(std::numbers::pi));
...
TEST_CASE("bool list", "[parser, list]") {
  ...
  const auto expected_ast = make_list_expr(make_expr_ptr<BoolExpr>(true),
                                           make_expr_ptr<BoolExpr>(true),
                                           make_expr_ptr<BoolExpr>(false));
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{true, true, false}};
...
TEST_CASE("expr list", "[parser, list]") {
  ...
  const auto expected_ast =
      make_list_expr(make_expr_ptr<ConditionExpr>(make_expr_ptr<IntExpr>(0),
                                                  make_expr_ptr<BoolExpr>(true),
                     ...
                     make_expr_ptr<IntExpr>(1) > make_expr_ptr<IntExpr>(2));
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{int64_t(0), int64_t(256),
                                                   false}};
...
TEST_CASE("simple list comprehension", "[parser, list comprehension]") {
  ...
  loops.emplace_back(make_expr_ptr<VariableExpr>("x"),
                     make_expr_ptr<VariableExpr>("dummy_array"),
                     std::vector<ExprPtr>{});
  const auto expected_ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>("x"), std::move(loops));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
                     int64_t(0), int64_t(1), int64_t(2), int64_t(3), int64_t(4),
...
TEST_CASE("expression list comprehension", "[parser, list comprehension]") {
  ...
  loops.emplace_back(make_expr_ptr<VariableExpr>("x"),
                     ...
                     std::vector<ExprPtr>{});
  const auto expected_ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>("x") * make_expr_ptr<IntExpr>(2),
      std::move(loops));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
  ...
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{
          int64_t(0), int64_t(2), int64_t(4), int64_t(6), int64_t(8),
          int64_t(10), int64_t(12), int64_t(14), int64_t(16), int64_t(18),
          int64_t(20)}};
...
TEST_CASE("simple list comprehension even", "[parser, list comprehension]") {
  ...
  conditions.emplace_back(make_expr_ptr<VariableExpr>("x") %
                              make_expr_ptr<IntExpr>(2) ==
  ...
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{int64_t(0), int64_t(2),
                                                   int64_t(4), int64_t(6),
...
TEST_CASE("simple list comprehension expression and condition",
          "[parser, list comprehension]") {
...
TEST_CASE("list comprehension inline list", "[parser, list comprehension]") {
  ...
  auto loops = std::vector<ListComprehensionExpr::loop>{};
  loops.emplace_back(make_expr_ptr<VariableExpr>("x"),
                     make_list_expr(make_expr_ptr<IntExpr>(int64_t(0)),
                                    make_expr_ptr<IntExpr>(int64_t(1))),
                     std::vector<ExprPtr>{});
  const auto expected_ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>("x"), std::move(loops));
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{int64_t(0), int64_t(1)}};
...
TEST_CASE("list comprehension if chains", "[parser, list comprehension]") {
  ...
  auto loops = std::vector<ListComprehensionExpr::loop>{};
  loops.emplace_back(make_expr_ptr<VariableExpr>("x"),
                     make_list_expr(make_expr_ptr<IntExpr>(int64_t(1)),
                                    make_expr_ptr<IntExpr>(int64_t(2)),
  ...
  const auto expected_ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>("x"), std::move(loops));
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{int64_t(2)}};
  const auto message = CuraFormulaeEngine::parser::parse(input);
  REQUIRE(message.has_value());
  const auto &ast = message.value();
  REQUIRE(ast.deepEq(expected_ast));
...
TEST_CASE("Nested list comprehension", "[parser, list comprehension]") {
  ...
  loops_b.emplace_back(
      ...
      make_list_expr(make_list_expr(make_expr_ptr<IntExpr>(int64_t(1)),
                                    make_expr_ptr<IntExpr>(int64_t(2))),
                     make_list_expr(make_expr_ptr<IntExpr>(int64_t(3)),
                                    make_expr_ptr<IntExpr>(int64_t(4)))),
      std::vector<ExprPtr>{});
  auto loops_a = std::vector<ListComprehensionExpr::loop>{};
  loops_a.emplace_back(
      make_expr_ptr<VariableExpr>("x"),
      make_expr_ptr<ListComprehensionExpr>(make_expr_ptr<VariableExpr>("y"),
                                           std::move(loops_b)),
      std::vector<ExprPtr>{});
  const auto expected_ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>("x"), std::move(loops_a));

  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{
          std::vector<CuraFormulaeEngine::eval::Value>{int64_t(1), int64_t(2)},
          std::vector<CuraFormulaeEngine::eval::Value>{int64_t(3),
                                                       int64_t(4)}}};
...
TEST_CASE("Flatten list comprehension condition",
          "[parser, list comprehension]") {
  ...
  custom_env.set(
      ...
      std::vector<CuraFormulaeEngine::eval::Value>{
          ...
          std::vector<CuraFormulaeEngine::eval::Value>{int64_t(6), int64_t(7),
                                                       int64_t(8)}});
...
TEST_CASE("Single quoted string", "[parser, string]") {
  ...
  const auto expected_ast =
      make_expr_ptr<StringExpr>(std::string("HELLO WORLD"));
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::string("HELLO WORLD"));
...
TEST_CASE("Double quoted string", "[parser, string]") {
  ...
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::string("FOO BAR"));
...
TEST_CASE("String with parenthesis", "[parser, string]") {
  ...
  const auto expected_ast =
      make_expr_ptr<StringExpr>(std::string("Marlin (Volumetric)"));
  const auto expected_eval =
      CuraFormulaeEngine::eval::Value(std::string("Marlin (Volumetric)"));
...
TEST_CASE("fn int", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("int")(make_expr_ptr<FloatExpr>(0.1));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(0));
...
TEST_CASE("fn int str input", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("int")(make_expr_ptr<StringExpr>("100"));
...
TEST_CASE("fn int str input base", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>(std::string("int"))(
      make_expr_ptr<StringExpr>("100"), make_expr_ptr<IntExpr>(int64_t(2)));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(4));
...
TEST_CASE("fn floor", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("math.floor")(make_expr_ptr<FloatExpr>(0.1));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(0.0);
...
TEST_CASE("fn ceil", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("math.ceil")(make_expr_ptr<FloatExpr>(0.1));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(1.0);
...
TEST_CASE("fn math.log(1)", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("math.log")(
      make_expr_ptr<IntExpr>(int64_t(1)));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(0.0);
...
TEST_CASE("fn math.log(1.0)", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("math.log")(make_expr_ptr<FloatExpr>(1.0));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(0.0);
...
TEST_CASE("fn math.log(4096, 8)", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("math.log")(
      make_expr_ptr<IntExpr>(int64_t(4096)),
...
TEST_CASE("fn math.log(True)", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("math.log")(make_expr_ptr<BoolExpr>(true));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(0.0);
...
TEST_CASE("condition True", "[parser, condition]") {
  ...
  const auto expected_ast = make_expr_ptr<ConditionExpr>(
      make_expr_ptr<IntExpr>(1), make_expr_ptr<BoolExpr>(true),
      make_expr_ptr<IntExpr>(0));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(1));
...
TEST_CASE("condition False", "[parser, condition]") {
  ...
  const auto expected_ast = make_expr_ptr<ConditionExpr>(
      make_expr_ptr<IntExpr>(1), make_expr_ptr<BoolExpr>(false),
      make_expr_ptr<IntExpr>(0));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(0));
...
TEST_CASE("nested condition 1", "[parser, condition]") {
  ...
  const auto expected_ast = make_expr_ptr<ConditionExpr>(
      make_expr_ptr<IntExpr>(1), make_expr_ptr<BoolExpr>(false),
      make_expr_ptr<ConditionExpr>(make_expr_ptr<IntExpr>(2),
                                   make_expr_ptr<BoolExpr>(false),
                                   make_expr_ptr<IntExpr>(3)));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(3));
...
TEST_CASE("nested condition 2", "[parser, condition]") {
  ...
  const auto expected_ast = make_expr_ptr<ConditionExpr>(
      ...
      make_expr_ptr<ConditionExpr>(
          make_expr_ptr<IntExpr>(2), make_expr_ptr<BoolExpr>(false),
          make_expr_ptr<ConditionExpr>(make_expr_ptr<IntExpr>(3),
                                       make_expr_ptr<BoolExpr>(false),
                                       make_expr_ptr<IntExpr>(4))));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(4));
...
TEST_CASE("index simple 0", "[parser, index]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>(
      std::string("dummy_array"))[make_expr_ptr<IntExpr>(0)];
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(0));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
...
TEST_CASE("slice index out of bounds positive", "[parser, index]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>(
      std::string("dummy_array"))[make_expr_ptr<IntExpr>(11)];
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
...
TEST_CASE("slice index out of bounds negative", "[parser, index]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>(
      std::string("dummy_array"))[-make_expr_ptr<IntExpr>(12)];
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
...
TEST_CASE("non integer index", "[parser, slice]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>(
      std::string("dummy_array"))[make_expr_ptr<FloatExpr>(0.1)];
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
...
TEST_CASE("simple slice", "[parser, slice]") {
  ...
  const auto expected_ast = make_expr_ptr<SliceExpr>(
      make_expr_ptr<VariableExpr>(std::string("dummy_array")),
...
TEST_CASE("reverse slice", "[parser, slice]") {
  ...
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{
          int64_t(10), int64_t(9), int64_t(8), int64_t(7), int64_t(6),
          int64_t(5), int64_t(4), int64_t(3), int64_t(2), int64_t(1),
          int64_t(0)}};
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
...
TEST_CASE("slice empty value start/end index step size", "[parser, slice]") {
  ...
  const auto expected_ast = make_expr_ptr<SliceExpr>(
      make_expr_ptr<VariableExpr>(std::string("dummy_array")), std::nullopt,
...
TEST_CASE("slice empty value start/end index negative step size",
          "[parser, slice]") {
  auto input = "dummy_array[::-1]"sv;
  const auto expected_ast = make_expr_ptr<SliceExpr>(
      make_expr_ptr<VariableExpr>(std::string("dummy_array")), std::nullopt,
      std::nullopt, -make_expr_ptr<IntExpr>(1));
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{
          int64_t(10), int64_t(9), int64_t(8), int64_t(7), int64_t(6),
          int64_t(5), int64_t(4), int64_t(3), int64_t(2), int64_t(1),
...
TEST_CASE("slice empty value start index, step size", "[parser, slice]") {
  ...
  const auto expected_ast = make_expr_ptr<SliceExpr>(
      make_expr_ptr<VariableExpr>(std::string("dummy_array")), std::nullopt,
      -make_expr_ptr<IntExpr>(2), std::nullopt);
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{
          int64_t(0), int64_t(1), int64_t(2), int64_t(3), int64_t(4),
          int64_t(5), int64_t(6), int64_t(7), int64_t(8)}};
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
...
TEST_CASE("non integer slice end index", "[parser, slice]") {
  ...
  const auto expected_ast = make_expr_ptr<SliceExpr>(
      make_expr_ptr<VariableExpr>(std::string("dummy_array")), std::nullopt,
      make_expr_ptr<FloatExpr>(0.1), std::nullopt);
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
...
TEST_CASE("non integer slice step size", "[parser, slice]") {
  ...
  const auto expected_ast = make_expr_ptr<SliceExpr>(
      make_expr_ptr<VariableExpr>(std::string("dummy_array")), std::nullopt,
      std::nullopt, make_expr_ptr<FloatExpr>(0.1));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
                 std::vector<CuraFormulaeEngine::eval::Value>{
...
TEST_CASE("index simple 10", "[parser, index]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>(
      std::string("dummy_array"))[make_expr_ptr<IntExpr>(10)];
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(10));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
...
TEST_CASE("index last", "[parser, index]") {
  auto input = "dummy_array[-1]"sv;
  const auto expected_ast = make_expr_ptr<VariableExpr>(
      std::string("dummy_array"))[-make_expr_ptr<IntExpr>(1)];
  const auto expected_eval = CuraFormulaeEngine::eval::Value(int64_t(10));
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
  custom_env.set("dummy_array",
...
TEST_CASE("fn any", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("any")(
      make_list_expr(make_expr_ptr<BoolExpr>(true)));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(true);
  ...
  custom_env.set(
      ...
      std::vector<CuraFormulaeEngine::eval::Value>{
          CuraFormulaeEngine::eval::Value(
              std::vector<CuraFormulaeEngine::eval::Value>{int64_t(0)})});
...
TEST_CASE("fn round", "[parser, fn]") {
  ...
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("round")(make_expr_ptr<FloatExpr>(1.5));
...
TEST_CASE("fn round base=1", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("round")(
      make_expr_ptr<FloatExpr>(1.5), make_expr_ptr<IntExpr>(int64_t(1)));
...
TEST_CASE("fn round base=-1", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("round")(
      make_expr_ptr<IntExpr>(int64_t(15)), -make_expr_ptr<IntExpr>(int64_t(1)));
...
TEST_CASE("fn round base=5", "[parser, fn]") {
  ...
  const auto expected_ast = make_expr_ptr<VariableExpr>("round")(
      make_expr_ptr<FloatExpr>(0.2) * make_expr_ptr<IntExpr>(60) /
          make_expr_ptr<IntExpr>(100),
...
TEST_CASE("fn list comprehension", "[parser, fn]") {
  ...
  loops.emplace_back(make_expr_ptr<VariableExpr>("x"),
                     ...
                     std::vector<ExprPtr>{});
  const auto expected_ast =
      make_expr_ptr<VariableExpr>("all")(make_expr_ptr<ListComprehensionExpr>(
          make_expr_ptr<VariableExpr>("x") <= make_expr_ptr<IntExpr>(10),
          std::move(loops)));
  const auto expected_eval = CuraFormulaeEngine::eval::Value(true);
  CuraFormulaeEngine::env::LocalEnvironment custom_env{
      &CuraFormulaeEngine::env::std_env};
...
TEST_CASE("free_variables(foo()) = { foo }", "[free variables, fn]") {
  auto ast = make_expr_ptr<FnApplicationExpr>(
      make_expr_ptr<VariableExpr>(std::string("foo")), std::vector<ExprPtr>{});
  auto free_variables = ast.freeVariables();
  REQUIRE(free_variables.size() == 1);
  REQUIRE(free_variables.contains(std::string("foo")));
}
...
TEST_CASE("free_variables(x^2) = { x }", "[free variables, x^2]") {
  auto ast = make_expr_ptr<PowExpr>(
      make_expr_ptr<VariableExpr>(std::string("x")), make_expr_ptr<IntExpr>(2));
  auto free_variables = ast.freeVariables();
  REQUIRE(free_variables.size() == 1);
  REQUIRE(free_variables.contains(std::string("x")));
}

TEST_CASE("free_variables([1, x, 2, y, 3]) = { x, y }",
          "[free variables, list]") {
  auto ast = make_list_expr(
      make_expr_ptr<IntExpr>(1), make_expr_ptr<VariableExpr>(std::string("x")),
      make_expr_ptr<IntExpr>(2), make_expr_ptr<VariableExpr>(std::string("y")),
      make_expr_ptr<IntExpr>(3));
  auto free_variables = ast.freeVariables();
...
TEST_CASE("free_variables([x for x in dummy_array]) = { dummy_array }",
          "[free variables, list comprehension]") {
  auto loops = std::vector<ListComprehensionExpr::loop>{};
  loops.emplace_back(make_expr_ptr<VariableExpr>(std::string("x")),
                     make_expr_ptr<VariableExpr>(std::string("dummy_array")),
                     std::vector<ExprPtr>{});
  auto ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>(std::string("x")), std::move(loops));
  auto free_variables = ast.freeVariables();
  REQUIRE(free_variables.size() == 1);
  REQUIRE(free_variables.contains(std::string("dummy_array")));
}

TEST_CASE("free_variables([x for x in x]) = { x }",
          "[free variables, list comprehension]") {
  auto loops = std::vector<ListComprehensionExpr::loop>{};
  loops.emplace_back(make_expr_ptr<VariableExpr>(std::string("x")),
...
TEST_CASE(
    "free_variables([item for row in matrix for item in row]) = { matrix }",
    "[free variables, list comprehension]") {
  auto loops = std::vector<ListComprehensionExpr::loop>{};
  loops.emplace_back(make_expr_ptr<VariableExpr>(std::string("row")),
                     make_expr_ptr<VariableExpr>(std::string("matrix")),
                     std::vector<ExprPtr>{});
  loops.emplace_back(make_expr_ptr<VariableExpr>(std::string("item")),
                     make_expr_ptr<VariableExpr>(std::string("row")),
                     std::vector<ExprPtr>{});
  auto ast = make_expr_ptr<ListComprehensionExpr>(
      make_expr_ptr<VariableExpr>(std::string("item")), std::move(loops));
  auto free_variables = ast.freeVariables();
  REQUIRE(free_variables.size() == 1);
  REQUIRE(free_variables.contains(std::string("matrix")));
}

TEST_CASE("real world expression", "[parser, fdm_printer.def.json example]") {
  auto input =
      "int(defaultExtruderPosition()) if resolveOrValue('adhesion_type') == 'raft' else -1"sv;

  const auto expected_ast = make_expr_ptr<ConditionExpr>(
      make_expr_ptr<VariableExpr>(std::string("int"))(
          make_expr_ptr<VariableExpr>(
              std::string("defaultExtruderPosition"))()),
...
TEST_CASE("s8 bottom_thickness setting parser",
          "[parser, fdm_printer.def.json example]") {
  auto input =
      "3*layer_height if top_layers==4 and not support_enable else top_bottom_thickness"sv;
...
TEST_CASE("Falcon infill", "[parser, fdm_printer.def.json example]") {
  auto input =
      "[-40,50] if infill_pattern in ('grid', 'lines', 'zigzag')  else [ ]"sv;
  const auto expected_eval = CuraFormulaeEngine::eval::Value{
      std::vector<CuraFormulaeEngine::eval::Value>{int64_t(-40), int64_t(50)}};
