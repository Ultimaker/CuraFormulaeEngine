...
std::string VariableExpr::toString() const noexcept { return name; }

eval::Result
VariableExpr::evaluate(const env::Environment *environment) const noexcept {
