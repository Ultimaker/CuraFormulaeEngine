...
[[nodiscard]] std::string Value::toString() const noexcept {
  ...
  if (std::holds_alternative<std::vector<Value>>(value)) {
    ...
    return fmt::format("[{}]",
                       list | ranges::views::transform([](const auto &element) {
...
[[nodiscard]] bool Value::deepEq(const Value &other) const noexcept {
  if (std::holds_alternative<bool>(value) &&
      std::holds_alternative<bool>(other.value)) {
  ...
  if (std::holds_alternative<std::int64_t>(value) &&
      std::holds_alternative<std::int64_t>(other.value)) {
    return std::get<std::int64_t>(value) == std::get<std::int64_t>(other.value);
  }
  if (std::holds_alternative<std::string>(value) &&
      std::holds_alternative<std::string>(other.value)) {
    return std::get<std::string>(value) == std::get<std::string>(other.value);
  }
  if (std::holds_alternative<std::nullptr_t>(value) &&
      std::holds_alternative<std::nullptr_t>(other.value)) {
    return true;
  }
  if (std::holds_alternative<std::vector<Value>>(value) &&
      std::holds_alternative<std::vector<Value>>(other.value)) {
    const auto &lhs = std::get<std::vector<Value>>(value);
    const auto &rhs = std::get<std::vector<Value>>(other.value);
    if (lhs.size() != rhs.size()) {
      return false;
    }
    return ranges::all_of(ranges::views::zip(lhs, rhs), [](const auto &pair) {
      const auto [element_lhs, element_rhs] = pair;
      return element_lhs.deepEq(element_rhs);
    });
  }
  if (std::holds_alternative<fn_t>(value) &&
      std::holds_alternative<fn_t>(other.value)) {
    return typeid(std::holds_alternative<fn_t>(value)) ==
           typeid(std::holds_alternative<fn_t>(other.value));
  }
  return false;
}
...
Result pow(const Value &lhs, const Value &rhs) {
  ...
  if (std::holds_alternative<std::int64_t>(lhs.value) &&
      std::holds_alternative<std::int64_t>(rhs.value)) {
    return static_cast<std::int64_t>(std::pow(
        std::get<std::int64_t>(lhs.value), std::get<std::int64_t>(rhs.value)));
  }
  if ((std::holds_alternative<std::int64_t>(lhs.value) ||
       std::holds_alternative<double>(lhs.value)) &&
      (std::holds_alternative<std::int64_t>(rhs.value) ||
       std::holds_alternative<double>(rhs.value))) {
    const auto lhs_value =
        std::holds_alternative<double>(lhs.value)
            ? std::get<double>(lhs.value)
            : static_cast<double>(std::get<std::int64_t>(lhs.value));
    const auto rhs_value =
        std::holds_alternative<double>(rhs.value)
            ? std::get<double>(rhs.value)
            : static_cast<double>(std::get<std::int64_t>(rhs.value));
...
bool operator==(const CuraFormulaeEngine::eval::Value &lhs,
  ...
  if (std::holds_alternative<bool>(lhs.value) &&
      std::holds_alternative<bool>(rhs.value)) {
  ...
  if (std::holds_alternative<std::int64_t>(lhs.value) &&
      std::holds_alternative<std::int64_t>(rhs.value)) {
    return std::get<std::int64_t>(lhs.value) ==
  ...
  if (std::holds_alternative<std::int64_t>(lhs.value) &&
      std::holds_alternative<double>(rhs.value)) {
    return static_cast<double>(std::get<std::int64_t>(lhs.value)) ==
           std::get<double>(rhs.value);
  }
  if (std::holds_alternative<bool>(lhs.value) &&
      std::holds_alternative<std::int64_t>(rhs.value)) {
    return (std::get<bool>(lhs.value) ? 1 : 0) ==
           std::get<std::int64_t>(rhs.value);
  }
  if (std::holds_alternative<std::int64_t>(lhs.value) &&
      std::holds_alternative<bool>(rhs.value)) {
    return std::get<std::int64_t>(lhs.value) ==
           (std::get<bool>(rhs.value) ? 1 : 0);
  }
  if (std::holds_alternative<bool>(lhs.value) &&
      std::holds_alternative<double>(rhs.value)) {
    return (std::get<bool>(lhs.value) ? 1.0 : 0.0) ==
           std::get<double>(rhs.value);
  }
  if (std::holds_alternative<double>(lhs.value) &&
      std::holds_alternative<bool>(rhs.value)) {
    return std::get<double>(lhs.value) ==
           (std::get<bool>(rhs.value) ? 1.0 : 0.0);
  }
  ...
  if (std::holds_alternative<std::vector<CuraFormulaeEngine::eval::Value>>(
          lhs.value) &&
      std::holds_alternative<std::vector<CuraFormulaeEngine::eval::Value>>(
          rhs.value)) {
    auto vector_lhs =
        std::get<std::vector<CuraFormulaeEngine::eval::Value>>(lhs.value);
    auto vector_rhs =
    ...
    return ranges::all_of(ranges::views::zip(vector_lhs, vector_rhs),
                          [](const auto &pair) {
                            const auto [element_lhs, element_rhs] = pair;
...
operator+(const CuraFormulaeEngine::eval::Value &lhs,
  ...
  if ((std::holds_alternative<bool>(lhs.value) ||
       std::holds_alternative<std::int64_t>(lhs.value)) &&
      (std::holds_alternative<bool>(rhs.value) ||
       std::holds_alternative<std::int64_t>(rhs.value))) {
    const auto lhs_value =
        std::holds_alternative<std::int64_t>(lhs.value)
            ? std::get<std::int64_t>(lhs.value)
            : static_cast<std::int64_t>(std::get<bool>(lhs.value));
    const auto rhs_value =
        std::holds_alternative<std::int64_t>(rhs.value)
            ? std::get<std::int64_t>(rhs.value)
            : static_cast<std::int64_t>(std::get<bool>(rhs.value));
  ...
  if ((std::holds_alternative<bool>(lhs.value) ||
      ...
      (std::holds_alternative<bool>(rhs.value) ||
       std::holds_alternative<double>(rhs.value))) {
    const auto lhs_value = std::holds_alternative<double>(lhs.value)
                               ? std::get<double>(lhs.value)
                               : static_cast<double>(std::get<bool>(lhs.value));
    const auto rhs_value = std::holds_alternative<double>(rhs.value)
                               ? std::get<double>(rhs.value)
                               : static_cast<double>(std::get<bool>(rhs.value));
    return lhs_value + rhs_value;
  }
  if ((std::holds_alternative<double>(lhs.value) ||
       std::holds_alternative<std::int64_t>(lhs.value)) &&
...
operator*(const CuraFormulaeEngine::eval::Value &lhs,
  ...
  if ((std::holds_alternative<std::string>(lhs.value) &&
      ...
      (std::holds_alternative<std::int64_t>(lhs.value) &&
       std::holds_alternative<std::string>(rhs.value))) {
    const auto &string = std::holds_alternative<std::string>(lhs.value)
                             ? std::get<std::string>(lhs.value)
                             : std::get<std::string>(rhs.value);
    const auto &times = std::holds_alternative<std::int64_t>(lhs.value)
                            ? std::get<std::int64_t>(lhs.value)
                            : std::get<std::int64_t>(rhs.value);
    std::string result;
...
CuraFormulaeEngine::eval::Result
CuraFormulaeEngine::eval::Value::operator[](const Value &index) const noexcept {
  ...
  if (index_value < 0) {
    index_value_absolute =
        static_cast<std::int64_t>(list.size()) - -index_value;
...
operator!(const CuraFormulaeEngine::eval::Value &operand) noexcept {
  if (std::holds_alternative<std::vector<CuraFormulaeEngine::eval::Value>>(
          operand.value)) {
    return std::get<std::vector<CuraFormulaeEngine::eval::Value>>(operand.value)
        .empty();
  }
...
operator-(const CuraFormulaeEngine::eval::Value &operand) noexcept {
  if (std::holds_alternative<bool>(operand.value)) {
    return std::get<bool>(operand.value) ? static_cast<std::int64_t>(-1)
